...
Sortable.mount(Remove, Revert);var sortable_esm=/*#__PURE__*/Object.freeze({__proto__:null,'default': Sortable,MultiDrag: MultiDragPlugin,Sortable: Sortable,Swap: SwapPlugin});var require$$0 = getCjsExportFromNamespace(sortable_esm);var vuedraggable_common = createCommonjsModule(function (module) {
module.exports =
...
const Item = Vue.component('virtual-list-item', {
    ...
    render(h) {
        return h(this.tag, {
            ...
            h(this.component, {
                props: Object.assign(Object.assign({}, this.extraProps), { source: this.source }),
            }),
        ]);
    },
});
...
var logger = new Logger({
    out: window.console,
    level: process && process.env && "production" === 'development'
        ? Level.DEBUG
        : Level.ERROR,
...
function sortableEventHandlers(context) {
    return sortableEvents.reduce((acc, eventName) => (Object.assign(Object.assign({}, acc), { [eventName]: context.$emit.bind(context, eventName) })), {});
}
const EVENT_TYPE = {
    ITEM: 'item_resize',
    SLOT: 'slot_resize',
        ...
        getRenderSlots(h) {
            ...
            return [
                h(Draggable, {
                    ...
                    on: Object.assign(Object.assign({ 
                        ...
                        } }, sortableEventHandlers(this)), { start: (e) => {
...
var DraggableVirtualList$1 = DraggableVirtualList;exports.default=DraggableVirtualList$1;